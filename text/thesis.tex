...
\thesislong{abstract}{
The purpose of this thesis is to lay foundation in VDO performance testing. Theoretical overview of VDO and it's components is presented with special emphasis on performance related structures. Opens source benchmark fs-drift was augmented with many features making it possible to test a block layer, specifically a VDO driver. Automated testing package and data processing tools were implemented to gather and process results from performance testing. Finally, many tests were conducted exploring performance of VDO while offering recommendation for VDO usage and performance testing.
