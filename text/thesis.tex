...
On Figure and Figure, results from such test can be examined. Physical space for this test was set to 5g with slab size of 2g, therefore this instance of VDO has one slab of data blocks. We can observe on the Figure that the workload caused the VDO to use half of its data blocks in about 12 seconds %{12}{\second}%. While looking at the Throughput graph, we can see that is the turning point for performance decrease.
