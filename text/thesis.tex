...
In older versions of VDO, asynchronous write mode was not compliand with ACID~\cite{Haerder83principlesof} policies. In case an application written data to a g

Async-unsafe option is there in case the user wants to keep the original non-ACID async write policy.
