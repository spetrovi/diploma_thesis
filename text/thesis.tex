...
Chapter~\ref{benchmarks} presents benchmarking tools \fio and \fsdrift, and their usage in testing VDO. Several new features were implemented in \fsdrift in order to better test VDO, as described here.
...
\begin{tabular}{|l|l|l|l|l|l|l|}
        \hline
        \multicolumn{7}{|l|}{Throughput of random discard (MB/s)} \\ \hline
