...
\caption[VDO threads load on default setting]{Thread load on default setting}
\label{fig:CPUdefault}
\end{minipage}
\begin{minipage}{.5\textwidth}
        \includegraphics[width=\linewidth]{../results/threads/direct/low_res/tar_132_threads.png}
\caption[VDO threads load after tuning]{Thread load after increasing number of threads}
\label{fig:CPUtuing}
...
\caption[Tuning VDO threads]{Testing of VDO volume created with increasing numbers of VDO threads}
